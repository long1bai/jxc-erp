...
public class WarehouseController {
    ...
    public Map<String, Object> delete(@PathVariable Long id) {
        ...
        if (mapper.countMovements(id) > 0) {
            return ApiResponse.fail("该仓库已有库存流水，不能删除（可改名称或停用）");
        }
